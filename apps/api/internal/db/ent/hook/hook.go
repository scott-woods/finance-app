...
// The RecurringInstanceFunc type is an adapter to allow the use of ordinary
// function as RecurringInstance mutator.
type RecurringInstanceFunc func(context.Context, *ent.RecurringInstanceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RecurringInstanceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RecurringInstanceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RecurringInstanceMutation", m)
}

// The RecurringItemFunc type is an adapter to allow the use of ordinary
// function as RecurringItem mutator.
type RecurringItemFunc func(context.Context, *ent.RecurringItemMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RecurringItemFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RecurringItemMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RecurringItemMutation", m)
}
