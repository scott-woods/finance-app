...
// was not loaded in eager-loading.
func (e CategoryEdges) RecurringItemsOrErr() ([]*RecurringItem, error) {
	if e.loadedTypes[1] {
...
func (*Category) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case category.FieldName, category.FieldKind:
...
// QueryRecurringItems queries the "recurring_items" edge of the Category entity.
func (_m *Category) QueryRecurringItems() *RecurringItemQuery {
	return NewCategoryClient(_m.config).QueryRecurringItems(_m)
}
